                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($tickets as $ticket)
                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                    ...
                                    {{-- Status --}}
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium {{ $s['class'] }}">
                                            {{ $s['label'] }}
                                        </span>
                                    </td>
                                    ...
                                    {{-- Replies --}}
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500 dark:text-gray-400">{{ $ticket->replies_count }} replies</span>
                                    </td>

                                    {{-- Date --}}
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500 dark:text-gray-400">{{ $ticket->created_at->format('d M Y') }}</span>
                                    </td>
