                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-4 py-3">
                                @if($log->file_name)
                                {{-- ✅ file_name সরাসরি দেখাও --}}
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    {{ $log->file_name }}
                                </p>
                                <p class="text-xs text-gray-400 mt-0.5 capitalize">
                                    {{ str_replace('_', ' ', $log->file_type ?? '') }}
                                </p>
                                @else
                                {{-- Fallback — পুরনো logs এর জন্য model title দেখাও --}}
                                @if($log->modelRecord)
                                <p class="text-sm text-gray-500 italic">{{ $log->modelRecord->title ?? 'N/A' }}</p>
                                @else
