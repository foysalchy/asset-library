...
@section('content')
    ...
    <div class="p-4 mx-auto w-full  md:p-6">
        ...
        <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
            ...
            <a href="{{ route('campaigns.show', $campaign) }}" class="hover:text-gray-700 dark:hover:text-gray-200 transition-colors truncate max-w-[200px]">{{ $campaign->title }}</a>
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"/></svg>
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Update the details for <span class="font-medium text-gray-700 dark:text-gray-300">{{ $campaign->title }}</span></p>
            </div>
