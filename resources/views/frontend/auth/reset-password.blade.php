                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $email) }}"
                            ...
                            class="shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-500 placeholder:text-gray-400 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 cursor-not-allowed @error('email') border-red-400 dark:border-red-500 @enderror" />
                    </div>
