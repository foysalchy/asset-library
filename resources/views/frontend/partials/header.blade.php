    ...
    <div class="absolute right-0 top-0 h-full w-[280px] bg-[#001e3e] shadow-2xl flex flex-col p-6 space-y-6">
        ...
        <div class="flex flex-col space-y-4 overflow-y-auto">
            ...
            <div class="pt-6 space-y-4">
                @guest
                    <a href="{{ route('frontend.signin') }}" class="flex items-center gap-3"><i class="fas fa-sign-in-alt"></i> Sign In</a>
                @endguest
                @auth
                    <a href="{{ route('profile.index') }}" class="flex items-center gap-3">
                        <img src="{{ Auth::user()->avatar_url ?? asset('./images/user/owner.jpg')}}" class="w-8 h-8 rounded-full">
