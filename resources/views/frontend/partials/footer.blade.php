    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 pb-10 border-b border-white/10">
            ...
            <div>
                ...
                <ul class="list-none p-0 m-0 flex flex-col gap-2.5">
                    <li><a href="{{ route('home.index') }}" class="text-sm text-white/55 hover:text-[#48b5e6] no-underline transition-colors">Home</a></li>
                    <li><a href="{{ route('home.filter') }}" class="text-sm text-white/55 hover:text-[#48b5e6] no-underline transition-colors">Latest Assets</a></li>
                    <li><a href="{{ route('profile.index') }}" class="text-sm text-white/55 hover:text-[#48b5e6] no-underline transition-colors">Download History</a></li>
                </ul>
            </div>
