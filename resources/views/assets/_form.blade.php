        ...
        <div class="rounded-xl border border-gray-100 bg-gray-50/50 p-4 dark:border-gray-700 dark:bg-gray-800/40 space-y-4">
            ...
            <div>
                ...
                <select name="status"
                    ...
                    <option value="active" {{ old('status', $isEdit ? $asset->status : 'active')       === 'active'  ? 'selected' : '' }}>Active</option>
                    <option value="draft" {{ old('status', $isEdit ? $asset->status : '') === 'draft'   ? 'selected' : '' }}>Draft</option>
                    <option value="expired" {{ old('status', $isEdit ? $asset->status : '')       === 'expired' ? 'selected' : '' }}>Expired</option>
                </select>
