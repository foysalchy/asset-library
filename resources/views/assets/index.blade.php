        ...
        <div class="flex flex-col gap-3 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <form method="GET" action="{{ route('assets.index') }}">
                    ...
                    @if(request('asset_type_id')) <input type="hidden" name="asset_type_id" value="{{ request('asset_type_id') }}"> @endif
                    <div class="relative">
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button" @click="openDelete('{{ $asset->id }}', '{{ addslashes($asset->title) }}')"
