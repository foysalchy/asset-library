...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="count-cell"><span class="count-badge"><?php echo e($log->count); ?></span></td>
    ...
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> <?php echo e($settings->site_name ?? config('app.name')); ?> — Confidential Report
    </div>
