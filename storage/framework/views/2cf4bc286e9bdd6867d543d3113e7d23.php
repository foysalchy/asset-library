...
<?php $__env->startSection('content'); ?>
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Updating: <span class="font-medium text-gray-700 dark:text-gray-300"><?php echo e($project->name); ?></span></p>
        </div>

        <form action="<?php echo e(route('projects.update', $project)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                <?php echo $__env->make('projects._form', ['project' => $project], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-management\resources\views\projects\edit.blade.php ENDPATH**/ ?>