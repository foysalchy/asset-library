...
<body>
    <div class="wrapper">
        ...
        <div class="footer">
            You received this email because you are a registered partner. &copy; <?php echo e(date('Y')); ?> Intel.
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\asset-library\resources\views/emails/new-content.blade.php ENDPATH**/ ?>