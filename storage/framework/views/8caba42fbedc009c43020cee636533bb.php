<?php $__env->startSection('content'); ?>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-4 py-0 md:px-8">
                            <img src="<?php echo e($campaign->thumbnail_url ?? asset('./images/cards/card-01.jpg')); ?>"
                                alt="<?php echo e($campaign->title); ?>" class="max-h-55 max-w-70 shadow-xl object-contain" />
                        </div>
                    ...
                    <div class="p-6 pt-10">
                        ...
                        <p class="text-[#757575] text-sm mb-3">
                            Topics: <span class="font-normal"><?php echo e($campaign->project->name ?? 'General'); ?></span>
                        </p>
                        ...
                        <div class="flex items-center gap-2.5 text-[#005da4] text-xs font-bold tracking-[1.2px] uppercase">
                            ...
                            <a href="<?php echo e(route('campaign.details', $campaign->slug)); ?>">More Details</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="container mx-auto px-6 py-12">
        <div class="flex items-center gap-3 mb-8">
            ...
            <a href="<?php echo e(route('home.filter')); ?>" class="bg-[#00aeef] text-white w-7 h-7 flex items-center justify-center">
                            ...
                            <div
                                ...
                                <div class="p-6 pt-9 flex flex-col flex-grow">
                                    ...
                                    <p class="text-[#757575] text-sm ">
                                        Topics:
                                        <span
                                            class="font-normal text-gray-500"><?php echo e($asset->project->name ?? 'General'); ?></span>
                                    </p>
                        ...
                        <div class="swiper-slide h-auto pb-5">
                            <div
                                ...
                                <div
                                    class="relative h-[200px] bg-[#001e3e] flex items-center justify-center overflow-visible p-4">
                                    <div class="h-full">
                                        <img src="<?php echo e($asset->media->first()->url ?? asset('assets/images/placeholder.jpg')); ?>"
                                            alt="<?php echo e($asset->title); ?>" class="h-full w-auto shadow-2xl object-contain" />
                                    </div>
                                    <button
                                        class="absolute top-2 right-4 text-[#00aeef] hover:scale-110 transition-transform">
                                        <i class="fa-regular fa-bookmark text-2xl"></i>
