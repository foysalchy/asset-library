...
<p>
    We received a request to reset the password for your <?php echo e($settings->site_name ?? 'Bhaiya Asset'); ?> account. Click the button below to choose a new password.
</p>

<div class="btn-wrap">
    <a href="<?php echo e($url); ?>" class="btn">Reset Password</a>
</div>
...
<?php echo $__env->make('emails.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-management\resources\views/emails/reset-password.blade.php ENDPATH**/ ?>