...
<p>
    Welcome to <?php echo e($settings->site_name ?? 'Bhaiya Asset'); ?>! Please confirm your email address to activate your account and get full access to our platform.
</p>

<div class="btn-wrap">
    <a href="<?php echo e($url); ?>" class="btn">Verify Email Address</a>
</div>
...
<?php echo $__env->make('emails.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-management\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>