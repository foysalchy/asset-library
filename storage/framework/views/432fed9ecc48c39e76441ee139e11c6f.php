...
<div class="p-4 mx-auto max-w-screen-2xl md:p-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]"
        x-data="{
            deleteModal: false, deleteId: null, deleteTitle: '',
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                <form method="GET" action="<?php echo e(route('assets.index')); ?>" id="filterForm" class="flex gap-2">
                    ...
                    <select name="asset_type_id" onchange="document.getElementById('filterForm').submit()"
                        ...
                        <option value="<?php echo e($type->id); ?>" <?php echo e(request('asset_type_id') == $type->id ? 'selected' : ''); ?>>
                ...
                <form method="GET" action="<?php echo e(route('assets.index')); ?>">
                    <?php if(request('project_id')): ?> <input type="hidden" name="project_id" value="<?php echo e(request('project_id')); ?>"> <?php endif; ?>
                    <?php if(request('asset_type_id')): ?> <input type="hidden" name="asset_type_id" value="<?php echo e(request('asset_type_id')); ?>"> <?php endif; ?>
                    <div class="relative">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-management\resources\views\assets\index.blade.php ENDPATH**/ ?>