...
<body class="bg-gray-50 dark:bg-gray-950 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Sign Up</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Enter your credentials to signup</p>
            </div>
...
<?php /**PATH C:\laragon\www\asset-library\resources\views/auth/signin.blade.php ENDPATH**/ ?>