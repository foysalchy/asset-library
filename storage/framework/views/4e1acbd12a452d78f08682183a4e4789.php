            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 text-gray-500">#<?php echo e($ticket->id); ?></td>
                        <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($ticket->subject); ?></td>
                        <td class="px-6 py-4">
                            <?php
                        ...
                        <td class="px-6 py-4 text-gray-500"><?php echo e($ticket->replies_count); ?></td>
                        <td class="px-6 py-4 text-gray-500"><?php echo e($ticket->created_at->format('d M Y')); ?></td>
                        <td class="px-6 py-4">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-400">
                            No tickets yet. <a href="<?php echo e(route('tickets.create')); ?>" class="text-[#0071c5] underline">Create one</a>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
