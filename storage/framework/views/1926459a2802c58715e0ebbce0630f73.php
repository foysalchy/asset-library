    ...
    <div class="rounded-xl border border-gray-100 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]"
        ...
        <div class="flex flex-col gap-3 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
                ...
                <form method="GET" action="<?php echo e(route('users.index')); ?>" id="filterForm" class="flex flex-wrap gap-2">
                    ...
                    <select name="sort" onchange="document.getElementById('filterForm').submit()"
                        ...
                        <option value="last_login" <?php echo e(request('sort') === 'last_login' ? 'selected' : ''); ?>>Last Active</option>
                    </select>
                ...
                <form method="GET" action="<?php echo e(route('users.index')); ?>">
                    ...
                    <?php if(request('date_from')): ?> <input type="hidden" name="date_from" value="<?php echo e(request('date_from')); ?>"> <?php endif; ?>
                    <?php if(request('date_to')): ?> <input type="hidden" name="date_to" value="<?php echo e(request('date_to')); ?>"> <?php endif; ?>
                ...
                <?php if(request()->anyFilled(['status', 'role_id', 'search', 'sort', 'date_from', 'date_to', 'per_page'])): ?>
                <a href="<?php echo e(route('users.index')); ?>"
                    class="h-[42px] flex items-center px-3 text-sm text-red-500 hover:underline whitespace-nowrap">
                    Clear Filters
                </a>
                <?php endif; ?>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-gray-200 border-y dark:border-gray-700">
                            ...
                            <th class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Employee ID</th>
                            <th class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Joining Date</th>
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <img src="<?php echo e($user->avatar_url ?: 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=3b82f6&color=fff'); ?>"
            ...
            <div class="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900"
                ...
                <div class="flex flex-col items-center text-center gap-4">
                    ...
                    <div class=" flex gap-3 w-full">
                                ...
                                <form :action="'<?php echo e(route('users.index')); ?>/' + deleteId" method="POST" class="flex-1">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-management\resources\views/users/index.blade.php ENDPATH**/ ?>