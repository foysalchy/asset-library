    ...
    'justify-start'">
        <a href="<?php echo e(route('dashboard')); ?>">
            ...
            <span x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen">
                ...
                <?php else: ?>
                <span class="w-8 h-8 rounded-lg bg-blue-500 flex items-center justify-center text-white font-bold text-sm">
...
<div x-show="$store.sidebar.isMobileOpen" @click="$store.sidebar.setMobileOpen(false)"
    class="fixed z-50 h-screen w-full bg-gray-900/50"></div><?php /**PATH C:\laragon\www\asset-management\resources\views\layouts\sidebar.blade.php ENDPATH**/ ?>