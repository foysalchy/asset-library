        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 pb-10 border-b border-white/10">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <div>
                        <div class="text-xl font-bold text-white leading-none"><?php echo e($settings->site_name ?? 'Bhaiya Asset'); ?></div>
                        <div class="text-sm text-[#90caf9] mt-0.5"><?php echo e($settings->slogan ?? 'Asset Management Platform'); ?>  </div>
                    </div>
                </div>
...
</footer><?php /**PATH C:\laragon\www\asset-library\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>