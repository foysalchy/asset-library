                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        <?php if(!$role->is_super_admin): ?>
                                            ...
                                            <button type="button" @click="openDelete(<?php echo e($role->id); ?>, '<?php echo e(addslashes($role->label)); ?>')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\asset-library\resources\views/roles/index.blade.php ENDPATH**/ ?>