    ...
    <section class="container mx-auto px-8 py-10 font-['Outfit']">
        ...
        <div id="assets" class="mb-12">
            <div class="flex items-center gap-2 mb-1">
                <h2 class="text-[22px] font-light text-gray-800">Saved Assets (<?php echo e($assets->count()); ?>)</h2>
...
<?php endif; ?>
        ...
        <div id="campaigns">
            <div class="flex items-center gap-2 mb-1">
                <h2 class="text-[22px] font-light text-gray-800">Saved Campaigns (<?php echo e($campaigns->count()); ?>)</h2>
