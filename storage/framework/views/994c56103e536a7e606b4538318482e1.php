...
<body class="bg-gray-50 dark:bg-gray-950 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Reset Password</h1>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email', $email)); ?>"
                            placeholder="info@example.com" required readonly
                            class="shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-500 placeholder:text-gray-400 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 cursor-not-allowed <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\laragon\www\asset-management\resources\views/frontend/auth/reset-password.blade.php ENDPATH**/ ?>